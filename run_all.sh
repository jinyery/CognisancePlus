...
"denosing")
    ...
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual_triplet_randaug --require_eval --train_type multi_center_dual_triplet_randaug --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual_triplet_randaug_denosing --require_eval --train_type multi_center_dual_triplet_randaug --phase train --seed $SEED --denosing
    ;;
"denosing_lt")
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/baseline --require_eval --train_type baseline --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/blsoftmax --require_eval --train_type blsoftmax --phase train --seed $SEED
