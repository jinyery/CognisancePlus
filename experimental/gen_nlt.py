...
# used_inst = list()
# selected = sampling_train_set(20000, cat_inst, used_inst)
# print(len(selected))

# data['selected'] = 0
# data.loc[selected,"selected"] = 1
# anno_path_out = os.path.join(anno_path, "verified_train_selected2.tsv")
...
# to_dir = "/home/yjy/Datasets/animal10n/training_selected2"
