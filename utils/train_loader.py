...
from train_multi_center_dual_triplet_tade import train_multi_center_dual_triplet_tade
from train_multi_center_dual_triplet_ride import train_multi_center_dual_triplet_ride
...
def train_loader(config):
    if (
        ...
        or config["training_opt"]["type"] == "multi_center_dual_triplet"
        or config["training_opt"]["type"] == "multi_center_dual_triplet_randaug"
        or config["training_opt"]["type"]
        == "multi_center_dual_triplet_randaug_blsoftmax"
        or config["training_opt"]["type"]
        == "multi_center_dual_triplet_randaug_logit_adj"
    ):
        return train_multi_center_dual
    elif config["training_opt"]["type"] == "multi_center_dual_triplet_randaug_tade":
        return train_multi_center_dual_triplet_tade
    elif config["training_opt"]["type"] == "multi_center_dual_triplet_randaug_ride":
        return train_multi_center_dual_triplet_ride
